(function( $ ) {
    ...
    /**
     * JQuery plugin for handling "page" navigation for a slider with pages containing
     * multiple items.
     * plnSlider gives navigation with pageButtons and right/left
     * 
     * Needed input is outer div, options containing pageButtonSpacing, itemsPerPage,
     * data array, templateFunction
     */
    $.fn.fnlSlider = function(options) {
        var self = this;
